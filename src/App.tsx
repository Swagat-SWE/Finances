...
export default function App() {
  ...
  if (view === 'import') return <ImportFlow accounts={accounts} categories={categories} importedStatements={importedStatements} onBack={() => setView('dashboard')} onComplete={finishImport}/>
